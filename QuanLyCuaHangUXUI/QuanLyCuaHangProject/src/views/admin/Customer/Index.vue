                  ...
                  <div class="col-md-3 text-center">
                    <div class="avatar-container">
                      <img
                        ...
                        :src="isEditMode && !currentCustomer.anh ? getApiUrl+`/HinhAnh/AnhKhachHang/`+currentCustomer.hinhDaiDien : currentCustomer.hinhDaiDien"
                        alt="Hình đại diện"
                        class="avatar-img"
                      />
                      <img
                ...
                <div class="col-md-3 text-center">
                  <div class="avatar-container">
                    <img
                      ...
                      :src= "getApiUrl + `/HinhAnh/AnhKhachHang/` + selectedCustomer.hinhDaiDien"
                      alt="Hình đại diện"
                      class="avatar-img"
                    />
                    <img
  ...
  methods: {
    ...
    async updateCustomer() {
      ...
      try {
        ...
        formData.append('gioiTinh', this.currentCustomer.gioiTinh.trim())
        if (this.currentCustomer.ngaySinh) {
          formData.append('ngaySinh', this.currentCustomer.ngaySinh.trim())
        }
        formData.append('diaChi', this.currentCustomer.diaChi.trim())
        formData.append('cccd', this.currentCustomer.cccd.trim())
        formData.append('sdt', this.currentCustomer.sdt.trim())
