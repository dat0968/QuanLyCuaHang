        ...
        <div class="xp-leftbar">    
            ...
            <div class="xp-sidebar">
                ...
                <div class="xp-logobar text-center">
                    <a href="index.html" class="xp-logo"><img src="../../assets/admin/images/logo.svg" class="img-fluid" alt="logo"></a>
                </div>
                <!-- End XP Logobar -->
                ...
                <div class="xp-navigationbar">
                    <ul class="xp-vertical-menu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <i class="icon-social-dropbox"></i><span>Danh sách mục</span><i class="icon-arrow-right pull-right"></i>
                            </a>
                            <ul class="xp-vertical-submenu">                                
                            ...
                            <ul class="list-inline mb-0">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="xp-message">
                                            <ul class="list-unstyled">
                                              ...
                                              <li class="media xp-msg">
                                                <img class="mr-3 align-self-center rounded-circle" src="../../assets/admin/images/topbar/user-message-1.jpg" alt="Generic placeholder image">
                                                <div class="media-body">
                                                    <a href="#">  
                                              ...
                                              <li class="media xp-msg">
                                                 <img class="mr-3 align-self-center rounded-circle" src="../../assets/admin/images/topbar/user-message-2.jpg" alt="Generic placeholder image">
                                                <div class="media-body">
                                                    <a href="#">
                                              ...
                                              <li class="media xp-msg">
                                                 <img class="mr-3 align-self-center rounded-circle" src="../../assets/admin/images/topbar/user-message-3.jpg" alt="Generic placeholder image">
                                                <div class="media-body">
                                                    <a href="#">
                                ...
                                <li class="list-inline-item mr-0">
                                    <div class="dropdown xp-userprofile">
                                        <a class="dropdown-toggle" href="#" role="button" id="xp-userprofile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../../assets/admin/images/topbar/user.jpg" alt="user-profile" class="rounded-circle img-fluid"><span class="xp-user-live"></span></a>
